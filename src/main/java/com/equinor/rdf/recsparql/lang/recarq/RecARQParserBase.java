...
package com.equinor.rdf.recsparql.lang.recarq;
...
/* 
 * This class a slight modification of org.apache.jena.sparql.lang.arq.ARQParserBase.
 ...
 *     PORTING CHANGES.
 *     THE IMPLEMENTATION BODY IS MEANT TO BE A DIRECT COPY OF
 *     org.apache.jena.sparql.lang.arq.ARQParserBase
 * 
 * In the event that the access modifier to org.apache.jena.sparql.lang.arq.ARQParserBase
 * is changed to "public" (or the inheritance structure is refactored), make a good-faith
 * effort to inherit the implementations in this class body from ARQParserBase, so that
 * the body if this class can be left empty.
*/
